...
with open('../classification-scripts/noun-modifications/dev-dict-format.json', 'r') as json_in:
...
def main():
    path_to_data = '../classification-scripts/noun-modifications/noun-modifications-dev-5-new-lines.json'
    ...
    with open('../classification-scripts/noun-modifications/noun-modifications-dev-v1.json', 'w') as json_out:
